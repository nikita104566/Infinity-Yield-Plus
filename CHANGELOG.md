...
### Improved
- Automation Studio command picker stays open when the typed name matches nothing and shows “No commands match” / “Нет подходящих команд” instead of vanishing.
