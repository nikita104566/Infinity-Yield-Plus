...
### Improved
- Command list rows keep the primary name fully visible and move aliases plus arguments onto a second dimmer line.

### Notes
- One loadstring of `source` is enough. Studio layout was not changed.
