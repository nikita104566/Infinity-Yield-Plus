...
### Improved
- Command list shows the primary name plus a compact +N alias count instead of a truncated /alias/alias chain; full aliases stay in the hover helper.

### Notes
- One loadstring: `source`. hotfix762 no longer overwrites a newer in-source version badge.
