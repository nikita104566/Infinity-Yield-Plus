...
Studio command picker no longer leaves empty rows: a no-match query keeps the list inside the panel and shows “No matching commands” / “Нет подходящих команд”.
