...
### Improved
- Automation Studio event list shows full event names (OnCharacterRemoving, OnWindowFocus) on two lines instead of clipping.

### Notes
- One loadstring of `source`. Version 7.63.
