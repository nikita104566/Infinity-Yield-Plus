...
### Improved
- Empty command bar: Down highlights the first visible command in the panel instead of only walking history. Up still walks history until a row is highlighted; then Up/Down move the highlight.
