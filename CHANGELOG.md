...
### Improved
- Command bar shows the current prefix as a gold chip on the left; it updates when you change Prefix in Settings.

### Notes
- Lives in `source` (apply APPLY_TO_SOURCE.diff hunks). One loadstring is enough.
