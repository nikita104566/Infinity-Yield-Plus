...
### Improved
- Automation Studio left list shows full event names (wraps `OnCharacterRemoving` instead of cutting to `OnCharact…`); the command-count badge moved onto the category line so the name keeps the column width.
