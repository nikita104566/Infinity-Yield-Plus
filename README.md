...
[![Version](https://img.shields.io/badge/version-7.65-blue.svg)](https://github.com/nikita104566/Infinity-Yield-Plus)
...
Open the panel with your prefix (default `;`). The current prefix sits on the left of the command bar — click it to change.
