...
↓ in the empty command bar highlights a row; Enter runs it, Tab fills the name. ↑ still browses history.

## Features

- Command panel with search, autocomplete, and a **Favorites** section at the top of the list
- ↓ highlights the command list from an empty bar; Enter runs the row, Tab fills it; ↑ browses history
