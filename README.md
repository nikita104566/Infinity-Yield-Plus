...
- Section headers show how many favorites and commands are currently visible
- Add or remove favorites from the helper popup or with right-click; they stay pinned in add order
- Command history is saved across reload and rejoin (`lastcommand`, up/down arrows)
