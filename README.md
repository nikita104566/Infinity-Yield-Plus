...
- Favorited rows show a star; the Favorites header shows how many are pinned
- Search hides long alias tails so the command name stays readable
- Empty search results show a clear no-match hint
- Add or remove favorites from the helper popup or with right-click
- Command history is saved across reload and rejoin
- Automation Studio, themes, keybinds, aliases, waypoints
- Russian / English UI
- Hot reload via `reload`

## Credits

Based on Infinite Yield and Infinite Yield Reborn.
