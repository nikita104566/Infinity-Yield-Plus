...
One loadstring is enough for the core panel and Automation Studio.

## Features

- Command panel with search, autocomplete, and a **Favorites** section at the top of the list
- Command rows show the name on the first line and `[args]` on the second so long signatures stay readable
