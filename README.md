...
- Command history is saved in `IY_FE.iy` across reload and rejoin (`lastcommand`, ↑ / ↓)
- Consecutive duplicates and `lastcommand` itself are not stored in history
- Empty `lastcommand` shows a notice instead of erroring
