...
Open the panel with your prefix (default `;`). One loadstring is enough. The command bar shows that prefix as a gold chip on the left.

## Features

- Command panel with search, autocomplete, and a **Favorites** section at the top of the list
- Command bar shows the current prefix as a gold chip on the left
