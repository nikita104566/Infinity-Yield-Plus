...
[![Version](https://img.shields.io/badge/version-7.71-blue.svg)](https://github.com/nikita104566/Infinity-Yield-Plus)
...
- `settings` / `opensettings` / `iypmenu` opens the settings panel from the command list
