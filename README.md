...
[![Version](https://img.shields.io/badge/version-7.68-blue.svg)](https://github.com/nikita104566/Infinity-Yield-Plus)
...
- `lastcommand` / `lastcmd` on an empty history shows a notice instead of erroring
