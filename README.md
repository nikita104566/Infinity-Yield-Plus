...
[![Version](https://img.shields.io/badge/version-7.70-blue.svg)](https://github.com/nikita104566/Infinity-Yield-Plus)
...
- Russian / English UI — switch with `lang` (or `uilang` / `language`) in the command panel
- Chain commands with `\\\\`
