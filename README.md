...
- Command names stay readable: one alias plus a +N count instead of a clipped slash-list
- Search highlights the matching letters; empty search shows a clear “no match” line
