...
Open the panel with your prefix (default `;`). One `source` loadstring is enough.
...
- `openstudio` / `autostudio` / `eventbinds` — open Automation Studio from the command list (run again to close)
