...
- Automation Studio — run command workflows on spawn, chat, tools, prompts, and other events; the add-command picker stays in the panel and says when nothing matches
