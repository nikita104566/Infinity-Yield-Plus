...
- Command panel with search, autocomplete, and a **Favorites** section at the top of the list (count + pin hint when empty)
- Long command names stay readable: primary name + alias count, not a chopped alias list
- Empty search keeps the panel open with a localized “no matches” line
