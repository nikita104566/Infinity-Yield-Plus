...
[![Version](https://img.shields.io/badge/version-7.69-blue.svg)](https://github.com/nikita104566/Infinity-Yield-Plus)
...
- Automation Studio — run command workflows on spawn, chat, tools, prompts, and other events; Inspector shows the selected event, `$` variables, and its commands
