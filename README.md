...
Open the panel with your prefix (default `;`). Type `studio` and press Enter to open Automation Studio.
...
- Automation Studio — run command workflows on spawn, chat, tools, prompts, and other events (`studio` from the panel)
