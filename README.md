...
- Long alias lists collapse to the primary name plus `/ alias +N` so the command you type stays readable
- Favorites show a star in the list; add or remove them from the helper popup or with right-click
