...
One loadstring is enough. Older `hotfix7xx.luau` / `patches.luau` files are optional leftovers and are not required.

## Features

- Command panel with search, autocomplete, compact primary-name rows, and a **Favorites** section at the top of the list
