...
- `;appver` (`iypver`, `showver`) shows the version from this `source` load
- Header version stays on the source build even if an old `patches.luau` / `hotfix762` is still executed
