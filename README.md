...
- `showhistory` / `hist` lists recent commands from this session
- `lastcommand` / `lastcmd` re-runs the previous command (safe when history is empty)
- Command history via ↑ / ↓ in the command bar
